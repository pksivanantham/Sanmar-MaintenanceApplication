...
{
    public partial class EquipmentSearchFormOSBL : Form
    {
        public EquipmentSearchFormOSBL()
        {
            InitializeComponent();
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                printDocument1.DocumentName = "Equipment OSBL";
        ...
        {
            string path = ConfigurationManager.AppSettings["EquipmentSpecificationSearchOSBLFilePath"];
